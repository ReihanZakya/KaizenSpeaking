...
class SignInActivity : AppCompatActivity(), View.OnClickListener, View.OnFocusChangeListener, View.OnKeyListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mViewModel = ViewModelProvider(this, SignInActivityViewModelFactory(AuthRepository(APIService.getService()), application)).get(SignInActivityViewModel::class.java)
        setupObservers()
    ...
    private fun setupObservers() {
        ...
        mViewModel.getLoginSuccess().observe(this) { isSuccess ->
            if (isSuccess) {
                navigateToHomeSignedActivity()
            }
        }
    }

    private fun navigateToHomeSignedActivity() {
        val intent = Intent(this, HomeSignInActivity::class.java)
    ...
    private fun submitForm() {
        if (validate()) {
            mViewModel.loginUser(LoginBody(binding.etEmail.text!!.toString(),binding.etPassword.text!!.toString()))
        }
    }
